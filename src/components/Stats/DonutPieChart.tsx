...
const DonutPieChart = ({
  ...
  return (
    <div className="mt-5 flex w-[100%] justify-around items-center donut-pie-chart-wrapper bg-[var(--card-bg-color)] border border-[var(--app-border-color)] rounded-2xl py-2">
      <section
